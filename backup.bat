@echo off
set "sourcedir=c:\Users\Tompe\Documents\kalenteri-main"
...
set "backupdir_name=kalenteri-main_backup_%CDATE%_%CTIME%"
set "destinationdir=c:\Users\Tompe\Documents\backupit\kalenteri\%backupdir_name%"
